...
규칙
1. 반드시 [학칙 관련 내용]에 있는 내용만 사용해서 답변합니다.
2. 질문과 직접 관련된 내용이 Context에 없으면, 학칙 내용을 추측하거나
   지어내지 않습니다. 대신 아래 형식으로 답합니다.
...
3. 추측하거나 일반적인 학교 규정을 말하지 않습니다 (Context에 있는
   내용만 학칙 내용으로 답합니다).
4. Context의 내용을 요약해서 답합니다.
"""
